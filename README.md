...
access their own data. It's built on the [Base44](https://base44.com) platform.
...
- [x] Core cycle logging, calendar, and prediction features
...
- [x] Reduced decorative clutter while keeping functional markers
- [x] **Security hardening** — tightened data-access rules so each user is fully scoped
